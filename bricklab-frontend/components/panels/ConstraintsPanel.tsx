          ...
          {constraints.map((c) => (
            <li key={c.id}>
              <div
                ...
                className="flex items-center gap-1.5 mx-3 px-2 py-1.5 rounded-none cursor-default group transition-colors text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800"
              >
